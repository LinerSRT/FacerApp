...
public class MathUtils {
    ...
    public static final Double NANOS_PER_SECOND = Double.valueOf(1.0E9d);
    public static final Double MICROS_PER_SECOND = Double.valueOf(1000000.0d);
    public static final Double MICROS_PER_UNIT = Double.valueOf(1000000.0d);
